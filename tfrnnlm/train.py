...
from tfrnnlm.text import whitespace_word_tokenization, IndexedVocabulary, language_model_batches
...
def train_model(args):
    ...
    batched_input, batched_targets = language_model_batches(data, args.batch_size)
